...
export const profile: ProfileData = {
  ...
  subTagline:
    "Software engineer building Android apps, web products, and automation tools. Founder of APEXLY.",
  ...
  aboutParagraphs: [
    "Hello! I'm Benjamin. I build software for Android and the web. I work with Kotlin, Jetpack Compose, TypeScript, PostgreSQL, and automation tools.",
